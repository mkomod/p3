...
\section{Definitions}
\textbf{Definition} \textit{Kullback-Leibler divergence}. Let $P$ and $Q$ be probability measures on $\Xc$, such that $ P $ is absolutely continuous with respect to $Q$ ($P \ll Q$), then the Kullback-Leibler divergence is defined as,
\begin{equation}\label{eq:kl}
\KL(P \| Q) = \int_{\Xc} \log \left( \frac{dP}{dQ} \right) dP
\end{equation}
...
The evidence lower bound is an used both as a goodness of fit measure, but also in assessing the convergence of the model.
